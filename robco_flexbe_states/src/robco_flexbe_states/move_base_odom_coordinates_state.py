...
class MoveBaseOdomCoordinatesState(EventState):
    """
    Navigates a robot to a desired position and orientation (in odom /robot/ coordinates) using move_base.
    ...
    def __init__(self):
        ...
        super(MoveBaseOdomCoordinatesState, self).__init__(outcomes = ['arrived', 'failed'],
                                            input_keys = ['waypoint'])
